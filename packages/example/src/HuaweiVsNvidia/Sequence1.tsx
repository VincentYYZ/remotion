...
const Logo: React.FC<{text: string; color: string; delay: number}> = ({text, color, delay}) => {
	...
	const topContent = (
		<div style={{display: 'flex', flexDirection: 'column', alignItems: 'center'}}>
			...
			<div style={{
				...
				<h1 style={{color: 'white', fontSize: '80px', margin: 0}}>NVIDIA H100</h1>
				<p style={{color: '#a0ffa0', fontSize: '40px', margin: 0}}>Comfort Zone</p>
			</div>
		</div>
	);
	...
	const bottomContent = (
		<div style={{display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', width: '100%', height: '100%'}}>
			<div style={{
				...
				<h1 style={{color: 'white', fontSize: '80px', margin: 0}}>Ascend 910B/C</h1>
			...
			<div style={{
				...
				opacity: interpolate(frame, [80, 120], [0, 1], {extrapolateRight: 'clamp', extrapolateLeft: 'clamp'}),
			}}>
