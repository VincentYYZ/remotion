...
// The markdown script content - edit this to change the video
const SCRIPT = `# 道路场景静态与动态要素识别系统
background: #fafafa
...
export const MarkdownVideoDemo: React.FC = () => {
	return <MarkdownVideo script={SCRIPT} />;
};
